...
from base import BaseTrainer, DataPrefetcher1
...
class Trainer(BaseTrainer):
    def __init__(self, model, loss, resume, config, train_loader, val_loader=None, train_logger=None, prefetch=True):
        ...
        if prefetch:
            self.train_loader = DataPrefetcher1(train_loader, device=self.device)
            self.val_loader = DataPrefetcher1(val_loader, device=self.device)
